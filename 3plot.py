...
def main():
    ...
    # ours_seeds = ['main_exp/walker/surf/seed_1/train.csv', 'main_exp/walker/surf/seed_2/train.csv']
    ...
    # pebble_seeds = [ 'main_exp/dooropen/pebble/seed_2/train.csv', 'main_exp/dooropen/pebble/seed_3/train.csv']
    # ours_seeds = ['main_exp/dooropen/ours/seed_3/train.csv', 'main_exp/dooropen/surf/seed_1/train.csv','main_exp/dooropen/surf/seed_3/train.csv']
    ...
    plt.figure()
    # Set a range limit here (e.g., 10000) or None for full range
    range_limit = 260000
    ...
    plt.xlabel('Environment Steps', fontsize=15)
    plt.ylabel('Episode Reward', fontsize=15)
    plt.title('Walker', fontsize=16)
